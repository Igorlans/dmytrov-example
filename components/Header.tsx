...
export const Header = () => {
    ...
    // const handleMobMenu = useCallback(() => {
    ...
    const activeStyle = useCallback((itemPath: string) => {
        const isActive = (pathName === itemPath);
        if (isActive) {
            return "header__nav-link header__nav-link_active";
        } else {
                ...
                <div className="container">
                        ...
                        <Link href="/">
                            <div className="header__logo">
                                <Image
                                    ...
                                    src={mobMenu ? "/assets/images/header-img/logo-mob.svg" : "/assets/images/header-img/logo.svg"}
                                    width={150}
                                    height={86}
                                    alt="logo"
                                />
                                <Image
                                    ...
                                    src={"/assets/images/header-img/logo.svg"}
                                    width={80}
                                    height={45}
                                    alt=""
                                />
                        ...
                        >
                            <div className="header__nav-doc">
                                <div className="header__socials">
                                    ...
                                    <Link target="_blank" className="header__socials-item"
                                          href={"viber://chat?number=%2B380992521329"}>
                                        <svg
                                            width="36"
                                            height="36"
                                            viewBox="0 0 36 36"
                            ...
                            <ul className="header__nav-list">
                                {dataMenu.map((item, idx) => (
                                    <li className="header__nav-item" key={idx}>
                                        <div
                                            className={activeStyle(item.link)}
                                        >
                                ...
                                <li className="header__nav-item">
                                    <div className="header__nav-link header__nav-link--accent" onClick={scrolling}>
                                        {/* <Link
                    ...
                    > */}
                                        ...
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M21.125 0.8125H4.875C2.63494 0.8125 0.8125 2.63494 0.8125 4.875V21.125C0.8125 23.3651 2.63494 25.1875 4.875 25.1875H21.125C23.3651 25.1875 25.1875 23.3651 25.1875 21.125V4.875C25.1875 2.63494 23.3651 0.8125 21.125 0.8125ZM23.5625 4.875V12.1875H13.8125V2.4375H21.125C22.4689 2.4375 23.5625 3.53113 23.5625 4.875ZM4.875 2.4375H12.1875V12.1875H2.4375V4.875C2.4375 3.53113 3.53113 2.4375 4.875 2.4375ZM2.4375 21.125V13.8125H12.1875V23.5625H4.875C3.53113 23.5625 2.4375 22.4689 2.4375 21.125ZM21.125 23.5625H13.8125V13.8125H23.5625V21.125C23.5625 22.4689 22.4689 23.5625 21.125 23.5625Z"
                                                fill="#E55733" />
                                            <path
                                                d="M4.875 8.125H6.5V9.75C6.5 10.1985 6.86319 10.5625 7.3125 10.5625C7.76181 10.5625 8.125 10.1985 8.125 9.75V8.125H9.75C10.1993 8.125 10.5625 7.761 10.5625 7.3125C10.5625 6.864 10.1993 6.5 9.75 6.5H8.125V4.875C8.125 4.4265 7.76181 4.0625 7.3125 4.0625C6.86319 4.0625 6.5 4.4265 6.5 4.875V6.5H4.875C4.42569 6.5 4.0625 6.864 4.0625 7.3125C4.0625 7.761 4.42569 8.125 4.875 8.125Z"
                                                fill="#E55733" />
                                            <path
                                                d="M16.25 8.125H21.125C21.5743 8.125 21.9375 7.761 21.9375 7.3125C21.9375 6.864 21.5743 6.5 21.125 6.5H16.25C15.8007 6.5 15.4375 6.864 15.4375 7.3125C15.4375 7.761 15.8007 8.125 16.25 8.125Z"
                                                fill="#E55733" />
                                            <path
                                                d="M21.125 19.5H16.25C15.8007 19.5 15.4375 19.864 15.4375 20.3125C15.4375 20.761 15.8007 21.125 16.25 21.125H21.125C21.5743 21.125 21.9375 20.761 21.9375 20.3125C21.9375 19.864 21.5743 19.5 21.125 19.5Z"
                                                fill="#E55733" />
                                            <path
                                                d="M21.125 16.25H16.25C15.8007 16.25 15.4375 16.614 15.4375 17.0625C15.4375 17.511 15.8007 17.875 16.25 17.875H21.125C21.5743 17.875 21.9375 17.511 21.9375 17.0625C21.9375 16.614 21.5743 16.25 21.125 16.25Z"
                                                fill="#E55733" />
                                            <path
                                                d="M8.46223 18.6874L9.61111 17.5385C9.9288 17.2208 9.9288 16.7073 9.61111 16.3896C9.29342 16.0719 8.77992 16.0719 8.46223 16.3896L7.31336 17.5385L6.16448 16.3896C5.8468 16.0719 5.3333 16.0719 5.01561 16.3896C4.69792 16.7073 4.69792 17.2208 5.01561 17.5385L6.16448 18.6874L5.01561 19.8371C4.69792 20.1548 4.69792 20.6683 5.01561 20.9859C5.17405 21.1444 5.38205 21.224 5.59005 21.224C5.79805 21.224 6.00605 21.1444 6.16448 20.9859L7.31336 19.8371L8.46223 20.9859C8.62067 21.1444 8.82867 21.224 9.03667 21.224C9.24467 21.224 9.45267 21.1444 9.61111 20.9859C9.9288 20.6683 9.9288 20.1548 9.61111 19.8371L8.46223 18.6874Z"
                                                fill="#E55733" />
                                        </svg>
                        ...
                        <div className="header__face">
                            <div className="header__face-bar">
                                <div className="header__face-item header__face-item-mob">
                                    <a className="header__face-link" href="#calculate">
                                        <svg
                                            width="20"
                                            height="20"
                                            viewBox="0 0 20 20"
                                ...
                                <div className="header__face-item">
                                    {locale === 'uk'
                                        ?
                                        <Link className="header__face-link" href={nextRouter.asPath} locale={'ru'}>
                                            UA
                                        </Link>
                                        :
                                        <Link className="header__face-link" href={nextRouter.asPath} locale={'uk'}>
                                            RU
                                        </Link>
                                    }
                                ...
                                <div
                                    ...
                                    onClick={() => session?.user ? router.push("/accountpage") : setIsOpen(true)}
                                >
                            ...
                            <div
                                ...
                                className="button header__face-btn">
